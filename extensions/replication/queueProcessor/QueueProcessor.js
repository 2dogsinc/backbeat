        ...
        redis.subscribe(channelName, err => {
            ...
            redis.on('message', (channel, message) => {
                const validActions = {
                    ...
                    cancelScheduledResumeService:
                        this._cancelScheduledResumeService.bind(this),
                };
                try {
